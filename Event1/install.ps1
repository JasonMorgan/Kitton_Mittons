...
New-Item -ItemType directory -Path $env:USERPROFILE\Documents\WindowsPowerShell\Modules\Pairs -Force | Out-Null
copy -path .\Pairs.psm1 -Destination $env:USERPROFILE\Documents\WindowsPowerShell\Modules\Pairs -Force
exit $LASTEXITCODE